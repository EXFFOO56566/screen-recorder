 ...
 */
package com.tochy.screenrecorder.notifictn
...
import com.tochy.screenrecorder.utilcmnuse.forwords.setViewVisibility
import com.tochy.screenrecorder.notifictn.providerschenl.NotificationChannelBuilder
...
const val RECORD_ACTION = "com.rdbrain.demo.service.START_RECORDING"
const val STOP_ACTION = "com.rdbrain.demo.service.STOP_RECORDING"
const val DELETE_ACTION = "com.rdbrain.demo.service.DELETE_RECORDING"
const val EXIT_ACTION = "com.rdbrain.demo.service.EXIT_FOREGROUND"
...
class RealNotifications(
  ...
  override fun createWidgetServiceNotification(
    ...
    val remoteViews = RemoteViews(
        "com.rdbrain.demo",
        R.layout.foreground_notification_layout
    ).apply {
