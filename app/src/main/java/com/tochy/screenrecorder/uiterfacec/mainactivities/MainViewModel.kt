...
import com.tochy.screenrecorder.utilcmnuse.rxdata.plusAssign
...
import com.tochy.screenrecorder.uiterfacec.ScopeViewModel
...
class MainViewModel(
...
) : ScopeViewModel(mainDispatcher), LifecycleObserver {
  ...
  fun invalidateFab() {
    ...
    if (captureEngine.isStarted()) {
      fabColorRes.value = R.color.redColor
