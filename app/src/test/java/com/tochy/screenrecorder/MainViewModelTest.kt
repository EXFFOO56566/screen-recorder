...
import com.tochy.screenrecorder.fileutiltest.InstantTaskExecutorR
import com.tochy.screenrecorder.fileutiltest.test
...
class MainViewModelTest {
  ...
  @Rule
  @JvmField
  var liveDataRule = InstantTaskExecutorR()
  ...
  fun invalidateFab_isStarted() {
    ...
    fabColor.assertValues(R.color.redColor)
